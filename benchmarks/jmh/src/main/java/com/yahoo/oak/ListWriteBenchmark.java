...
//        }
   ...
   /* --------------------------------------------------*****************------------------------------------------------*/
    ...
    @Threads(thread2)
    @Benchmark
    public void writeNova2(Blackhole blackhole,BenchmarkState state,ThreadState threadState) {
   ...
   /* --------------------------------------------------*****************------------------------------------------------*/
    ...
    @Threads(thread4)
    @Benchmark
    public void writeNova4(Blackhole blackhole,BenchmarkState state,ThreadState threadState) {
   ...
   /* --------------------------------------------------*****************------------------------------------------------*/
    ...
    @Threads(thread8)
    @Benchmark
    public void writeNova8(Blackhole blackhole,BenchmarkState state,ThreadState threadState) {
   ...
   /* --------------------------------------------------*****************------------------------------------------------*/
    ...
    @Threads(thread12)
    @Benchmark
    public  void writeNova12(Blackhole blackhole,BenchmarkState state,ThreadState threadState) {
   ...
   /* --------------------------------------------------*****************------------------------------------------------*/
    ...
    @Threads(thread16)
    @Benchmark
    public void writeNova16(Blackhole blackhole,BenchmarkState state,ThreadState threadState) {
   ...
   /* --------------------------------------------------*****************------------------------------------------------*/
    ...
    @Threads(thread20)
    @Benchmark
    public void writeNova20(Blackhole blackhole,BenchmarkState state,ThreadState threadState) {
   ...
   /* --------------------------------------------------*****************------------------------------------------------*/
    ...
    @Threads(thread24)
    @Benchmark
    public void writeNova24(Blackhole blackhole,BenchmarkState state,ThreadState threadState) {
   ...
   /* --------------------------------------------------*****************------------------------------------------------*/
    ...
    @Threads(thread32)
    @Benchmark
    public void writeNova32(Blackhole blackhole,BenchmarkState state,ThreadState threadState) {
