...
declare -A becnh_size=(						
						["LL_EBR_CAS_bench"]="64082"
						["LL_EBR_noCAS_bench"]="64082"
						["LL_EBR_CAS_opt_bench"]="64082"
						["LL_EBR_noCAS_opt_bench"]="64082"

						["LL_HE_CAS_bench"]="64082"
						["LL_HE_noCAS_bench"]="64082"
						["LL_HE_CAS_opt_bench"]="64082"
						["LL_HE_noCAS_opt_bench"]="64082"

                       ["LL_Nova_CAS_bench"]="64082"
                       ["LL_Nova_noCAS_bench"]="64082"
                       ["LL_Nova_primitive_CAS_bench"]="64082"
                       ["LL_Nova_primitive_noCAS_bench"]="64082"
					   ["LL_Nova_Magic_noCAS_bench"]="64082"
        ...
        for write in ${writes}; do
          for t in ${thread}; do
            #for i in ${size}; do
              ...
              out=${output}/oak-${scenario}-${bench}-t${t}-${gcAlg}.log
