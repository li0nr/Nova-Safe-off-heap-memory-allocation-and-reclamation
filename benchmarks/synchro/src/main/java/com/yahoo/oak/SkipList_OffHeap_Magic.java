...
public class SkipList_OffHeap_Magic implements CompositionalLL<Buff,Buff> {
    ...
    public SkipList_OffHeap_Magic(long MemCap) {
    	if(MemCap != -1)
        ...
        new Facade_Slice_MagicNumber(mng);
    }
	...
	public Integer containsKey(final Buff key, int tidx) {
		...
		if(value == null)
			...
			Integer ret = (Integer)Facade_Slice_MagicNumber.Read(Buff.DEFAULT_R, value);
    ...
    public  boolean put(final Buff key,final Buff value, int idx) {
    	...
    	Facade_Slice_MagicNumber.AllocateSlice(offValue, Buff.DEFAULT_SERIALIZER.calculateSize(value), idx);
    ...
    public  boolean OverWrite(final Buff key,final Buff value, int idx) {
    	...
    	{	
    		if(v == null) return v;
    		Facade_Slice_MagicNumber.OverWrite( (value1)-> {
    ...
    public  boolean putIfAbsent(final Buff key,final Buff value, int idx) {    
    	Facade_slice offValue = new Facade_slice();
    	Facade_Slice_MagicNumber.AllocateSlice(offValue, Buff.DEFAULT_SERIALIZER.calculateSize(value), idx);
    	Facade_slice valueOff = skipListMap.putIfAbsent(key, Facade_Slice_MagicNumber.WriteFast(Buff.DEFAULT_SERIALIZER, value, offValue, idx));
    	if(valueOff != null)
    		Facade_Slice_MagicNumber.DeletePrivate(idx, offValue); 
    ...
    public  boolean remove(final Buff key, int idx) {
    	...
    	return val == null ? false : Facade_Slice_MagicNumber.Delete(idx, val); 
    }
    ...
    static public void main(String[]arg) {
    	SkipList_OffHeap_Magic myskip = new SkipList_OffHeap_Magic(1);
    	Buff x = new Buff(4);
    			x.set(0);
    	myskip.put(x, x, 0);
