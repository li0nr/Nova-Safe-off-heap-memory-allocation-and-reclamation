...
import com.nova.LL.HE.LL_HE_noCAS.Node;
/**
 ...
 */
public class LL_HE_noCAS_opt<K,V> {
    ...
    public <R> R get(K key, NovaR Reader, int tidx) {
        ...
        CmpFail: while(true)
        	try {
		        ...
		        HE.clear(tidx);
		        access = HE.get_protected(curr.value, tidx);
		        R obj = null;
		        if (flag)
