...
public class MemorySegmentNovaAllocator implements BlockMemoryAllocator {
    ...
    public MemorySegmentNovaAllocator(long capacity) {
        this(capacity, BlocksPool.getInstance());
    }

    // A testable constructor
    MemorySegmentNovaAllocator(long capacity, BlocksProvider blocksProvider) {
