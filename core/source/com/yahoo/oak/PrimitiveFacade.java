...
public class PrimitiveFacade <T> {
	...
	static public boolean AllocateSlice(long data, int size, int idx) {
        ...
        return UNSAFE.compareAndSwapLong(data, 0, data, facadeNewData) ?
...
//	
//	
//	public PrimitiveFacade Write(long toWrite,int idx ) {//for now write doesnt take lambda for writing 
//
//		long facademeta = FacadeMetaData;
...
//	}
//	
//	public <T> PrimitiveFacade WriteFull (NovaSerializer<T> lambda, T obj, int idx ) {//for now write doesnt take lambda for writing 
//
//		long facademeta = FacadeMetaData;
//		if(facademeta%2==DELETED) {
//			throw new IllegalArgumentException("cant locate slice");
...
//
//	
//	public PrimitiveFacade WriteFast(NovaSerializer<T> lambda, T obj, int idx ) {//for now write doesnt take lambda for writing 
//		long facademeta = FacadeMetaData;
//		
//		if(facademeta%2!=0)
//			throw new IllegalArgumentException("cant locate slice");
