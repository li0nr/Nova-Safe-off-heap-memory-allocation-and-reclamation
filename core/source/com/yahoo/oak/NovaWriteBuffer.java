 ...
 */
final class NovaWriteBuffer extends NovaReadBuffer implements OakScopedWriteBuffer, OakUnsafeDirectBuffer {
     ...
     */
    static <T> void serialize(NovaSlice s, T obj, OakSerializer<T> serializer) {
    	NovaWriteBuffer writeBuffer = new NovaWriteBuffer(s);
     ...
     */
    static void compute(NovaSlice s, Consumer<OakScopedWriteBuffer> computer) {
    	NovaWriteBuffer writeBuffer = new NovaWriteBuffer(s);
