...
import com.yahoo.oak.SimpleArray.SA_Nova_Primitive_CAS_Magic;
...
public class SA_Test {
	...
	@Test
	public void SA_Nova_Magic(){
		SA_Nova_Primitive_CAS_Magic mySA = new SA_Nova_Primitive_CAS_Magic(Buff.DEFAULT_SERIALIZER); 
	    Buff x =new Buff(12);
